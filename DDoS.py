...
def helptext ():
        print "Usage: %s is 1.1 for GNU/Linux - Free Open Dos and DDos testing tool <hostname/ip target> [-t] [-c] [-p]\n" % sys.argv[0]
        print " EX. python2 NumexDdos.py www.website.com/ip taget -t 1000 -c 1000 -p 80"
        print ""
        ...
        print ""
        print " CODER BY : 『TZIZ』"
        print " CODER BY : 『Zero0N3』"
        print ""
        print ""
        print ""
        print "NOTE: ABUSE = REVENGE BY SYSTEM"
        print ""
        print ""
        print ""
        print " ~~@mrezoiz
        print " ~~@mr.zero0n3
        print "Contact for any BUGS or GLITCHES on Instagram @mrezoiz & @mr.zero0n3 Your feedback is helpfull"
        exit()
...
def main (args):
        ...
        while i < len(args):
                ...
                i += 1
        if host == None:
                print "Enter a hostname/ip target"
                exit()
        start() #start going
        ...
        while True:
                ...
                for i in range (connection_amount):
                        ...
                        try:
                                ...
                                col()
                                print " # | - ERROR IN THREAD %d: COULD NOT CONNECT [Maybe Server Down!] " % num
                                bleh = True
                if bleh:
                        continue
